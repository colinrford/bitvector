...
// My bitvector struct. Although it was stated in the extra cred prompt
// that most bitvectors are less than 30 bits, I found it convenient
// to include the number of bits within the bitvector struct. I used a
// char* since each char is only a single byte, making it simple to create
// smaller bitvectors as well as keep the standard 8:1 ratio between bits
// and bytes.
